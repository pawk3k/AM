...
import com.example.detailflow.activities.JoggingDetailActivity
                ...
                if (tablet) {
                    val fragment = JoggingDetailFragment().apply {
                        arguments = Bundle().apply {
                            putString(JoggingDetailFragment.ARG_ITEM_ID, description)
                        }
                    }
                    ...
                    val intent = Intent(this.context, JoggingDetailActivity::class.java).apply {
                        putExtra(JoggingDetailFragment.ARG_ITEM_ID, description)
                    }
